import { n as getPglite, t as ensureDbReady } from "./db-DCMnXnsA.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/server-C1BWQei4.js
...
function resolveGateEndpoints(headers) {
	...
	if (!env$2("GROK_PROJECT_ID")) return {
